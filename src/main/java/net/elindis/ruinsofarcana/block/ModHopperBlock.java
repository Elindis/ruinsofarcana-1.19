...
extends BlockWithEntity {
    ...
    public ModHopperBlock(Settings settings) {
        super(settings);
    ...
    public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
        return world.isClient ? null : ModHopperBlock.checkType(type, ModBlockEntities.AURIC_PIPE, ModHopperBlockEntity::serverTick);
    }
