...
public class ResearchParchmentBlock_2 extends Block {
    ...
    public ResearchParchmentBlock_2(Settings settings) {
        super(settings);
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockHitResult hit) {
        ...
        if (player.getMainHandStack().isOf(ModItems.AURIC_INGOT) && player.getOffHandStack().isOf(ModItems.SCRIBES_PEN)) {
            ...
            // Important
            world.setBlockState(pos, ModBlocks.RESEARCH_PARCHMENT_3.getDefaultState().with(FACING, world.getBlockState(pos).get(FACING)));
