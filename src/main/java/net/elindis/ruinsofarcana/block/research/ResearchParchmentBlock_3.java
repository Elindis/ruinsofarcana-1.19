...
public class ResearchParchmentBlock_3 extends Block {
    ...
    public ResearchParchmentBlock_3(Settings settings) {
        super(settings);
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockHitResult hit) {
        ...
        if (player.getMainHandStack().isOf(ModItems.AURIC_INGOT) && player.getOffHandStack().isOf(ModItems.SCRIBES_PEN)) {
            ...
            // Important
            world.setBlockState(pos, ModBlocks.RESEARCH_PARCHMENT_4.getDefaultState().with(FACING, world.getBlockState(pos).get(FACING)));
