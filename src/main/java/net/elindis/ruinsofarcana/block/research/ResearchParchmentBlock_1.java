...
public class ResearchParchmentBlock_1 extends Block {
    ...
    public ResearchParchmentBlock_1(Settings settings) {
        super(settings);
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockHitResult hit) {
        ...
        if (player.getMainHandStack().isOf(ModItems.AURIC_INGOT) && player.getOffHandStack().isOf(ModItems.ARCANISTS_STAFF)) {
            ...
            // Important
            world.setBlockState(pos, ModBlocks.RESEARCH_PARCHMENT_2.getDefaultState().with(FACING, world.getBlockState(pos).get(FACING)));
