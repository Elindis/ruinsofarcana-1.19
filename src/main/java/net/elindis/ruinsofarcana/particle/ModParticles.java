...
public class ModParticles {
	...
	public static final DefaultParticleType SNOW_TORNADO_PARTICLE = FabricParticleTypes.simple();
	...
	public static void registerParticles() {
		...
		Registry.register(Registry.PARTICLE_TYPE, new Identifier(RuinsOfArcana.MOD_ID, "snow_tornado_particle"), SNOW_TORNADO_PARTICLE);
