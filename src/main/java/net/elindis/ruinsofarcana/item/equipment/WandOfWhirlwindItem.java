...
public class WandOfWhirlwindItem extends RangedWeaponItem implements Vanishable {
    ...
    public void usageTick(World world, LivingEntity user, ItemStack stack, int remainingUseTicks) {
        ...
        if (random2 > 6) {
            ...
            world.addParticle(ParticleTypes.WHITE_ASH, xPos, yPos+0.2, zPos, random, random, random);
            world.addParticle(ParticleTypes.WHITE_ASH, xPos, yPos+0.25, zPos, random, random, random);
        }
    }
                ...
                if (((double)f > 0.50)) {
                        ...
                        if (playerEntity.totalExperience > 5 || playerEntity.getAbilities().creativeMode) {
                            ...
                            if (!world.isClient) {
                                ...
                                playerEntity.addStatusEffect(new StatusEffectInstance(ModEffects.REPEL, 600, 0, false, false, false));
                            }
