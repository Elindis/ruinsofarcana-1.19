...
import net.elindis.ruinsofarcana.screen.slot.ModFuelSlot;
import net.elindis.ruinsofarcana.screen.slot.ModResultSlot;
...
public class ManufactoryScreenHandler extends ScreenHandler {
    ...
    public ManufactoryScreenHandler(int syncId, PlayerInventory playerInventory) {
        // changed to 5 from 4
    ...
    public ManufactoryScreenHandler(int syncId, PlayerInventory playerInventory,
        ...
        super(ModScreenHandlers.MANUFACTORY_SCREEN_HANDLER, syncId);
        // changed to 5 from 4
        ...
        // added 3rd crafting slot
        this.addSlot(new Slot(inventory, 3, 18, 16));
        // yay
        this.addSlot(new ModResultSlot(inventory, 4, 114, 33));
    ...
    public int getScaledFuelProgress() {
        ...
        if (maxFuelProgress == 0 || fuelProgress == 0) {
            return 0;
        }

        return fuelProgress * 13 / maxFuelProgress;
    }
